...
public class JSErrorDataSender extends PayloadSender {
    static final String JSERROR_COLLECTOR_PATH = "/mobile/errors?protocol_version=1&platform=reactnative";
    ...
    protected HttpURLConnection getConnection() throws IOException {
        ...
        connection.setConnectTimeout(agentConfiguration.getErrorCollectorTimeout());
        connection.setReadTimeout(agentConfiguration.getErrorCollectorTimeout());
