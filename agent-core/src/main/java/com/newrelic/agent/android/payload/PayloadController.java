...
import com.newrelic.agent.android.hybrid.MobileErrorDataReporter;
...
public class PayloadController implements HarvestLifecycleAware {
    ...
    public static PayloadController initialize(final AgentConfiguration agentConfiguration) {
        if (instance.compareAndSet(null, new PayloadController(agentConfiguration))) {
            ...
            MobileErrorDataReporter mobileErrorDataReporter = MobileErrorDataReporter.initialize(agentConfiguration);
            if (mobileErrorDataReporter != null) {
                mobileErrorDataReporter.start();
            } else {
                log.warn("MobileErrorDataController: No mobile error reporter - mobile error reporting will be disabled");
            }
            ...
            try {
                ...
                if (queueExecutor != null) {
                    ...
                    try {
                        ...
                        MobileErrorDataReporter.shutdown();
