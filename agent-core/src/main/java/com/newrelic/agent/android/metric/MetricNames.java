...
public class MetricNames {
    ...
    public static final String SUPPORTABILITY_SESSION_REPLAY_REMOVED_REJECTED = SUPPORTABILITY_SESSION_REPLAY + "Removed/Rejected";
    public static final String SUPPORTABILITY_SESSION_REPLAY_UNCOMPRESSED = SUPPORTABILITY_SESSION_REPLAY + "Size/Uncompressed";
    public static final String SUPPORTABILITY_SESSION_REPLAY_EXPIRED = SUPPORTABILITY_SESSION_REPLAY + "Expired";
