...
public class MetricNames {
    ...
    public static final String SUPPORTABILITY_MOBILE_ANDROID_CONFIG_SESSIONREPLAY_SAMPLING_RATE_VALUE = SUPPORTABILITY_MOBILE_ANDROID_CONFIG_SESSIONREPLAY + "/SamplingRate";
    public static final String SUPPORTABILITY_MOBILE_ANDROID_CONFIG_SESSIONREPLAY_ERROR_SAMPLING_RATE_VALUE = SUPPORTABILITY_MOBILE_ANDROID_CONFIG_SESSIONREPLAY + "/ErrorSamplingRate";
}
