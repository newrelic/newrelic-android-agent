...
public class MetricNames {
    ...
    public static final String SUPPORTABILITY_COLLECTOR_CONNECTION_ERRORS = SUPPORTABILITY_COLLECTOR + "Connection/Errors";
    public static final String SUPPORTABILITY_COLLECTOR_CONNECT = SUPPORTABILITY_COLLECTOR + "Connect";
    public static final String SUPPORTABILITY_COLLECTOR_RESPONSE_ERROR_CODES = SUPPORTABILITY_COLLECTOR + "ResponseErrorCodes/";
    public static final String SUPPORTABILITY_COLLECTOR_HARVEST = SUPPORTABILITY_COLLECTOR + "Harvest";
    public static final String SUPPORTABILITY_COLLECTOR_HARVEST_ERROR_UNKNOWN = SUPPORTABILITY_COLLECTOR + "Harvest/Error/UNKNOWN";
    public static final String SUPPORTABILITY_COLLECTOR_HARVEST_BACKGROUND = SUPPORTABILITY_COLLECTOR + "Harvest/Background";
    public static final String SUPPORTABILITY_COLLECTOR_HARVEST_CONNECT_ERROR = SUPPORTABILITY_COLLECTOR + "Harvest/Connect/Error/";
    public static final String SUPPORTABILITY_COLLECTOR_HARVEST_ERROR_BACKGROUND = SUPPORTABILITY_COLLECTOR + "Harvest/Error/Background/";
    public static final String SUPPORTABILITY_COLLECTOR_HARVEST_ERROR = SUPPORTABILITY_COLLECTOR + "Harvest/Error/";
    public static final String SUPPORTABILITY_COLLECTOR_HARVEST_OFFLINE_STORAGE = SUPPORTABILITY_COLLECTOR + "Harvest/OfflineStorage/";
    ...
    public static final String SUPPORTABILITY_MOBILE_ANDROID_WEBVIEW_LOAD_URL = SUPPORTABILITY_MOBILE_ANDROID_WEBVIEW + "LoadUrl";
    public static final String SUPPORTABILITY_MOBILE_ANDROID_WEBVIEW_POST_URL= SUPPORTABILITY_MOBILE_ANDROID_WEBVIEW + "PostUrl";
    ...
    public static final String SUPPORTABILITY_MOBILE_ANDROID_WEBSOCKET_CLOSE = SUPPORTABILITY_MOBILE_ANDROID_WEBSOCKET + "Close";
    public static final String SUPPORTABILITY_MOBILE_ANDROID_WEBSOCKET_MESSAGE_RECEIVED = SUPPORTABILITY_MOBILE_ANDROID_WEBSOCKET + "MessageReceived";
    ...
    public static final String SUPPORTABILITY_MOBILE_ANDROID_CONFIG_SESSIONREPLAY_SAMPLING_RATE_VALUE = SUPPORTABILITY_MOBILE_ANDROID_CONFIG_SESSIONREPLAY + "SamplingRate/Value";
    public static final String SUPPORTABILITY_MOBILE_ANDROID_CONFIG_SESSIONREPLAY_ERROR_SAMPLING_RATE_VALUE = SUPPORTABILITY_MOBILE_ANDROID_CONFIG_SESSIONREPLAY + "ErrorSamplingRate/Value";
