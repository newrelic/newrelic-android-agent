...
public class TraceMethodVisitor extends AdviceAdapter {
    ...
    protected void onMethodEnter() {
        ...
        final Method traceMachineEnterMethod = new Method("enterMethod", "(Lcom/newrelic/agent/android/tracing/Trace;Ljava/lang/String;Ljava/util/ArrayList;)V");

        // public static void TraceMachine.enterMethod(String name)
        // final Method traceMachineEnterMethod = new Method("enterMethod", "(Lcom/newrelic/agent/android/tracing/Trace;Ljava/lang/String;)V");
        ...
        if ((access & Opcodes.ACC_STATIC) != 0) {
            ...
            super.visitLabel(tryStart);
            {
                ...
                super.getField(Type.getObjectType(context.getClassName()), TraceMachine.NR_TRACE_FIELD, Type.getType(TraceMachine.NR_TRACE_TYPE));
