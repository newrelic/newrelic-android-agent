...
public class InvocationDispatcherTest {
    ...
    public void visitClassBytes() {
        ...
        Assert.assertTrue(classBytes.length < classData.getMainClassBytes().length);
    }
    ...
    public void testInstrumentationDisabled() {
        ...
        System.clearProperty(RewriterAgent.DISABLE_INSTRUMENTATION_SYSTEM_PROPERTY);
        System.setProperty(RewriterAgent.DISABLE_INSTRUMENTATION_SYSTEM_PROPERTY, "true");
    ...
    public void hasInstrumentedAnnotation() {
        ...
        testContext.verifyClassTrace(classData.getMainClassBytes(), testContext.classWriter, targets);
    }
