...
public class ActivityClassVisitorTest {
    ...
    public void visit() {
        ...
        Assert.assertFalse(cn.interfaces.contains(TraceClassDecorator.TRACE_FIELD_INTERFACE_CLASS));
        ...
        Assert.assertTrue(cn.interfaces.contains(TraceClassDecorator.TRACE_FIELD_INTERFACE_CLASS));
    }
    ...
    public void injectCodeIntoMethod() {
        ...
        for (Method m : ActivityClassVisitor.methodDelegateMap.keySet()) {
            ...
            if (mn != null) {
                ...
                targets.add("INVOKEVIRTUAL " + cv.applicationStateMonitorType.getClassName().replace('.', '/')
