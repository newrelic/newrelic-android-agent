...
/*
 * The default ClassWriter tries to load classes through the wrong classloader.
 * Patch it to use the correct classloader.
 */
public class PatchedClassWriter extends ClassWriter {
    ...
    /*
     * Override this method and reimplement to use the correct classloader.
     */
