/**
 * WebDriverIO Configuration - Android Session Replay (Agent ON, Session Replay ON)
 *
...
exports.config = {
  ...
  capabilities: [{
    ...
    'lt:options': {
      ...
      platformVersion: '14',
      isRealMobile: true,
      build: 'Android Agent Performance Test - Session Replay',
      name: 'Session Replay Performance - With SR (SR ON)',
      video: true,
      console: true,
      network: false,
      devicelog: true
  ...
  onPrepare: function (config, capabilities) {
    console.log('\n==============================================');
    console.log('🎥 Android Performance Test - SESSION REPLAY');
