/**
 * WebDriverIO Configuration - Android No Agent (Pure Baseline)
 *
...
exports.config = {
  ...
  capabilities: [{
    ...
    'lt:options': {
      ...
      platformVersion: '14',
      isRealMobile: true,
      build: 'Android Agent Performance Test - No Agent',
      name: 'Session Replay Performance - No Agent (Pure Baseline)',
      video: true,
      console: true,
      network: false,
      devicelog: true
  ...
  onPrepare: function (config, capabilities) {
    ...
    console.log('\n==============================================');
    console.log('📱 Android Performance Test - NO AGENT');
